        ...
        <!-- /.sidebar -->
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-success" href="request.php">View Purchase Request</a>
            </h1>
            <ol class="breadcrumb">
...
?>
                      <tr>
                        ...
                        <td>
        <a href="#updateordinance<?php echo $row['prod_id'];?>" data-target="#updateordinance<?php echo $row['prod_id'];?>" data-toggle="modal" class="btn btn-success">Request Purchase</a>
